...
/**
 * HttpBridgeAgent: recebe /api/config (JSON), escreve config.properties e notifica TDA.
 */
    ...
    private class ConfigHandler implements HttpHandler {
        ...
        public void handle(HttpExchange exchange) throws IOException {
            ...
            try {
                ...
                // notify TDA (TaskDecomposerAgent) with protocol api-config
                ACLMessage msg = new ACLMessage(ACLMessage.INFORM);
                msg.addReceiver(new AID("tda", AID.ISLOCALNAME));
                msg.setProtocol("api-config");
                msg.setContent(body); // forward JSON (TDA can parse)
                send(msg);
